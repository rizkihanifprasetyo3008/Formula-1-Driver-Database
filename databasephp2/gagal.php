...
<body>
    ...
    <div class="container_popup">
        ...
        <div class="popup" id="popup">
            ...
            <h2>Gagal Menambahkan/Mengedit!</h2>
            <p>Gagal menambahkan/mengedit data driver formula 1 ke database!</p>
            <a href="./tambah.php"><button type="button">Coba Input Data Ulang</button></a>
        </div>
    </div>
