...
<body>
    ...
    <section class="tabel_driver">
        <div class="container_popup">
            <h2>Form Tambah Data Formula 1 Driver</h2>
            ...
            <form method="POST" class="form_tambahdata" enctype="multipart/form-data">
                <ul>
                    <li>
                        ...
                        <br>
                        <input type="text" name="Nama_Driver" id="Nama_Driver" class="form_tambahdata_input" placeholder="input here..." required>
                    </li>
                    <li>
                        <label class="form_tambahdata_Text">Tim Konstruktor :</label>
                        <br>
                        <input type="text" name="Tim_Konstruktor" id="Tim_Konstruktor" class="form_tambahdata_input" placeholder="input here..." required>
                    </li>
                    <li>
                        <label class="form_tambahdata_Text">Asal Negara :</label>
                        <br>
                        <input type="text" name="Asal_Negara" id="Asal_Negara" class="form_tambahdata_input" placeholder="input here..." required>
                    </li>
                    <li>
                        <label class="form_tambahdata_Text">Tempat Lahir :</label>
                        <br>
                        <input type="text" name="Tempat_Lahir" id="Tempat_Lahir" class="form_tambahdata_input" placeholder="input here..." required>
                    </li>
                    <li>
                        <label class="form_tambahdata_Text">Tanggal Lahir :</label>
                        <br>
                        <input type="text" name="Tanggal_Lahir" id="Tanggal_Lahir" class="form_tambahdata_input" placeholder="input here..." required>
                    </li>
                    <li>
                        <label class="form_tambahdata_Text">Umur :</label>
                        <br>
                        <input type="text" name="Umur" id="Umur" class="form_tambahdata_input" placeholder="input here..." required>
                    </li>
                    <li>
                        <label class="form_tambahdata_Text">Debut Balapan :</label>
                        <br>
                        <input type="text" name="Debut_Balapan" id="Debut_Balapan" class="form_tambahdata_input" placeholder="input here..." required>
                    </li>
                    <li>
                        <label class="form_tambahdata_Text">World Champions :</label>
                        <br>
                        <input type="text" name="World_Champions" id="World_Champions" class="form_tambahdata_input" placeholder="input here..." required>
                    </li>
                    <li>
                        <label class="form_tambahdata_Text">Nomer Pembalap :</label>
                        <br>
                        <input type="text" name="Nomer_Pembalap" id="Nomer_Pembalap" class="form_tambahdata_input" placeholder="input here..." required>
                    </li>
                    <li>
                    ...
                    <li>
                        <div class="popup" id="popup">
                            ...
                            <h2>Apakah anda yakin ingin menambahkan data?</h2>
                            <p>Data yang telah diisi akan langsung dimasukkan ke dalam database, pastikan semua sudah benar</p>
                        ...
                        <a href="#Nama_Driver"><button type="button" name="submit1" onclick="openPopup()" ;>Tambah Data</button></a>
                    </li>
                </ul>
            </form>
        </div>
